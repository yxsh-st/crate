...
public class AlterTableRerouteAnalyzerTest extends CrateDummyClusterServiceUnitTest {
    ...
    @Test
    public void testRerouteRetryOnUnpartitionedTableWithPartitionIsNotAllowed() throws Exception {
        expectedException.expect(IllegalArgumentException.class);
        expectedException.expectMessage("table 'doc.users' is not partitioned");
        e.analyze("ALTER TABLE doc.users PARTITION (col_a = NULL) REROUTE RETRY FAILED");
    }
    ...
    public void testRerouteRetryFailed() throws Exception {
        ...
        assertThat(analyzed.partitionName().isPresent(), is(false));
