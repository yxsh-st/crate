...
public class BooleanColumnReference extends FieldCacheExpression<SortedNumericDVIndexFieldData, Boolean> {

    private static final BytesRef TRUE_BYTESREF = new BytesRef("1");
    private SortedBinaryDocValues values;
    private Boolean value;

    public BooleanColumnReference(String columnName, MappedFieldType mappedFieldType) {
